...
export const {
  ...
  useServicesQuery,
  useSingleProviderServiceQuery,
  useProviderServicesQuery,
  useOfferServicesProviderQuery,
  useOfferServicesQuery,
  useDeleteOfferServiceMutation,
  useApplyOfferMutation,
  useOverviewQuery,
  useAdditionalServiceQuery,
  useRelatedServiceQuery,
