    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-6 xl:gap-8">
          {/* Basic Plan */}
          <div className="group relative bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 p-8 lg:p-10 border border-gray-100 hover:border-[#1f54dd]/20">
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-[#1f54dd]/10 to-blue-100 rounded-2xl mb-6">
                <div className="w-8 h-8 bg-[#1f54dd] rounded-lg"></div>
              </div>
            ...
            <div className="space-y-4 mb-8">
              {[
                ...
                <div key={index} className="flex items-start gap-3">
                  <div className="flex-shrink-0 w-6 h-6 bg-[#1f54dd]/10 rounded-full flex items-center justify-center mt-0.5">
                    <FiCheck className="w-4 h-4 text-[#1f54dd]" />
                  </div>
            ...
            <Link href="/combo-pack/basic" className="block">
              <button className="w-full bg-white text-[#1f54dd] border-2 border-[#1f54dd] font-semibold px-8 py-4 rounded-2xl hover:bg-[#1f54dd] hover:text-white transition-all duration-300 shadow-lg hover:shadow-xl group-hover:scale-105 flex items-center justify-center gap-2">
                Choose Basic Plan
          ...
          <div className="group relative bg-gradient-to-br from-[#1f54dd] to-blue-600 rounded-3xl shadow-2xl p-8 lg:p-10 transform lg:scale-105 lg:-translate-y-4">
            {/* Popular Badge */}
            ...
            <Link href="/combo-pack/standard" className="block">
              <button className="w-full bg-white text-[#1f54dd] font-semibold px-8 py-4 rounded-2xl hover:bg-blue-50 transition-all duration-300 shadow-lg hover:shadow-xl group-hover:scale-105 flex items-center justify-center gap-2">
          ...
          <div className="group relative bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 p-8 lg:p-10 border border-gray-100 hover:border-[#1f54dd]/20">
            ...
            <Link href="/combo-pack/premium" className="block">
              <button className="w-full bg-gradient-to-r from-[#1f54dd] to-blue-600 text-white font-semibold px-8 py-4 rounded-2xl hover:from-blue-600 hover:to-[#1f54dd] transition-all duration-300 shadow-lg hover:shadow-xl group-hover:scale-105 flex items-center justify-center gap-2">
                Choose Premium Plan
                <FiArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </button>
            </Link>
