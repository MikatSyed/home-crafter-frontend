...
const OfferedServices = () => {
  ...
  return (
    ...
    <div className="bg-white py-10 md:py-14">
        ...
        <div className="flex flex-wrap items-center">
          <div className="w-full md:w-1/2" data-aos="fade-up">
            ...
            <p className="text-gray-400 mt-4">
              Limited-time offer on our services. Don't miss out—grab it before
              it expires!
            </p>
          </div>
      ...
      <p className="text-indigo-600 font-bold">{service.offer.discount} OFF</p>
    </div>
                  </div>
                </div>
                ...
                <div className="mt-4 text-sm text-indigo-600">
                    <p>
                      ...
                      {parseInt(service?.daysLeft) > 0 ? ` (${service?.daysLeft} days left)` : " (Last day!)"}
                    </p>
