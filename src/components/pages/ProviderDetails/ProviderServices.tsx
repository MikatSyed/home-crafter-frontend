...
const ProviderServices = ({services,category,profileImg,fName,lName}:any) => {
      ...
      >
        {services?.map((service: any, index: number) => (
          <SwiperSlide key={index}>
            <div
              className="border rounded-md hover:shadow-lg"
                ...
                <div className="item-info absolute bottom-0 right-0 p-4 flex items-center justify-start w-full">
                  <a href="providers.html" className="flex items-center">
                    <img
                      ...
                      alt="User"
                    />
                    <span className="ml-2 text-white">{`${fName} ${lName}`}</span>
                  </a>
                </div>
              </div>
              <div className=" p-4">
                ...
                <div className="flex items-center justify-between mt-2">
                  ...
                  <p className="flex items-center">
                    ...
                    <Rating rating={service?.averageRating || 0} /> ({service?.averageRating || 0})
                    </span>
                  </p>
                </div>
